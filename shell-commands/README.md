    ...
    * [Commands - Tooling](#Commands---Tooling)
      ...
      * [less (zless), (multi)tail, vim](#less-zless-multitail-vim)
        * [less](#less)
          ...
          * [auto scroll if new lines are appended (i.e. log files)](#auto-scroll-if-new-lines-are-appended-ie-log-files)
      ...
      * [CTRL+z (sleep), fg (foreground), jobs](#CTRLz-sleep-fg-foreground-jobs)
